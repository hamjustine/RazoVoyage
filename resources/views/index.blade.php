...
<div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              ...
              <p><a href="{{route('voyages')}}" class="btn btn-primary py-3 px-5 text-white">Book Now!</a></p>
        ...
        <div class="nonloop-block-13 owl-carousel">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6 mb-5">
                  <img src="{{ asset('images/img_1.jpg')}}" alt="Image" class="img-md-fluid">
                </div>
          ...
          <div class="item">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 mb-5">
                  <img src="{{ asset('images/img_2.jpg')}}" alt="Image" class="img-md-fluid">
                </div>
                <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                  <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
          ...
          <div class="item">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 mb-5">
                  <img src="{{ asset('images/img_4.jpg')}}" alt="Image" class="img-md-fluid">
                </div>
                <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                  <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
                  <p class="">&mdash; <em>James Martin</em>, <a href="#">Traveler</a></p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>1])}}" class="unit-1 text-center">
              <img src="{{ asset('images/01-greece.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>2])}}" class="unit-1 text-center">
              <img src="{{ asset('images/02-rome.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>3])}}" class="unit-1 text-center">
              <img src="{{ asset('images/03-japan.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$390</strong>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>4])}}" class="unit-1 text-center">
              <img src="{{ asset('images/04-dubai.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>5])}}" class="unit-1 text-center">
              <img src="{{ asset('images/05-london.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{route('voyage',['id'=>6])}}" class="unit-1 text-center">
              <img src="{{ asset('images/06-australia.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$390</strong>
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url({{ asset('images/hero_bg_2.jpg')}}; background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-12">
            ...
            <p class="mb-0"><a href="{{route('voyages')}}" class="btn btn-primary py-3 px-5 text-white">Book Now</a></p>
          </div>
        </div>
      </div>
    </div>
