...
<div class="alert alert-success alert-dismissible fade show mb-0" role="alert">
            ...
            <strong>Bravo</strong> Votre voyage a bien été modifié ! 
          </div>
          @endif
 <!-- / .main-navbar --> <form class="update-post" method="post" action="{{route('updatePost',['id'=> $voyage->id])}}">
 @csrf
 <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Modifier un voyage</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
              <div class="col-lg-9 col-md-12">
                ...
                <div class="card card-small mb-3">
                  <div class="card-body">
                      ...
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="titre" name="titre" value="{{$voyage->titre}}">
                      <!-- <div id="editor-container" class="add-new-post__editor mb-1"></div> -->
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="destination" name="destination" value="{{$voyage->destination}}">
                      <textarea rows="10" class="form-control form-control-lg mb-3" type="text" placeholder="description" name="description" value="{{$voyage->description}}"></textarea>
                      <input class="form-control form-control-lg mb-3" type="number" placeholder="prix" name="prix" value="{{$voyage->prix}}" >
                      <input class="form-control form-control-lg mb-3" type="text" placeholder="url image" name="image" value="{{$voyage->image}}">
